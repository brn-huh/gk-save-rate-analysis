...
- **표본 투명성** — 경기수 게이트(50/100/200 토글) + 모든 순위에 경기수·선방률 95% 신뢰구간(±%p) 표기.
...
- **검색** — 선수 이름 필터
- **정렬 토글** — 선방률 / GSAx / GSAx(초근제외) / 경기수
- **경기수 게이트 토글** — 50 / 100 / 200 (표본 적은 뽀록 상위권을 걸러 봄)
- **행마다** — 선수 이미지·시즌 엠블럼 아이콘·급여·선방률 신뢰구간(±%p)
- **행 클릭 → 펼침** — 액션샷 히어로 + 급여·OVR·키·몸무게·체형 칩 + 거리 구간별·슛 타입별 표
